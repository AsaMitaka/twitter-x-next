    ...
    <div className="border-b-[1px] border-neutral-800 pb-4">
      ...
      <div className="mt-8 px-4">
        <div className="flex flex-col">
          <p className="text-white text-2xl font-semibold">{fetchUser?.username}</p>
          <p className="text-neutral-600 text-md font-semibold">@{fetchUser?.username}</p>
        </div>
        ...
        <div className="flex flex-row items-center mt-4 gap-6">
          <div className="flex flex-row items-center gap-1">
            <p className="text-white cursor-pointer hover:underline">
              {fetchUser?.followingIds?.length}
            </p>
            <p className="text-neutral-500">Following</p>
          </div>
          <div className="flex flex-row items-center gap-1">
            <p className="text-white cursor-pointer hover:underline">
              {fetchUser?.followersCount || 0}
            </p>
